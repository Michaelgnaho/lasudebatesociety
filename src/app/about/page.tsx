...
const alumniYears: AlumniYear[] = [
  ...
  },
  {
    ...
    members: [
      ...
      "Kadiri Naomi",
      "Ogunlaja Oluwanifesimi Temitope",
  ...
  },
  {
    ...
    members: [
      ...
      "Fathia Adetola",
      "Olatunji Mafe",
      "Adedeji Ngbede Aderounmu",
      "Odichukwumma Dorcas Mordi",
    ],
  },
  {
    ...
    members: [
      ...
      "Abdulrahman Adam Adio",
      "Olaniyi Oreoluwa Mosunmola",
      "Fadare Nojibat Ayooluwatobi",
      "Ajasa Kehinde Timilehin",
      "Zainab Ogunnowo",
      "Obadimeji Oluwakorede",
      "Ojikutu Boluwatife Deborah",
      "Temitope Bakare",
      "Olawale Kafayat",
      "Adeniken Ilerioluwa",
      "Saheed Sunday",
      "Moyomade Adegbite",
      "Ololade Oladele Olajide",
      "Olayiwola Oluwapelumi Grace",
      "Oliaku Deborah Ese",
      "Obadimeji David",
      "Mariam Oluwapelumi Busari",
      "Mariam Adegbola",
      "Esther Mosopefoluwa Oginni",
      "Boluwatifemi Bamijoko",
      "Israel Adedoyin",
    ],
  },
  {
    ...
    members: [
      ...
      "Favour Oluwatuyi",
      "Sylvester Agose",
      "Taiwo Abigail Ayomide",
      "Precious Oyeleye",
      "Similoluwa Sharon Ifedayo",
      "Aishat Salami",
      "Aminat Babatunde",
      "Ajeniya Abdulquadri Oluwagbemiga",
      "Adeleye Oladimeji Habeeb",
      "Olarinre Fiyinfoluwa Deborah",
      "Rianot Ajoke Haruna",
      "Asikaburu Miracle Ezinne",
      "Ojulari Zainab Opeyemi",
      "Akano Abdulmalik Kolade",
      "Teniola Elizabeth Olarinde",
      "Adeniji Tomiwa Azeez",
      "Orenuga Erioluwa Rose",
      "Nuroh Abdulrahmon",
      "Maryam Motunrayo Lawal",
      "Balogun Sherifat Abimbola",
